...
//% weight=100 color=#3f0000 icon="\uf043" block="Color:Bit"
namespace envirobit {
    ...
    export function getcolor(): number {
        ...
        if ((Math.round(_tcs3472.rgb()[0]) > 1200) && (Math.round(_tcs3472.rgb()[0] / 2) > (Math.round(_tcs3472.rgb()[1]))) &&
            (Math.round(_tcs3472.rgb()[0] / 3) > (Math.round(_tcs3472.rgb()[2])))) { 
            return 0
            //红
        }

        if ((Math.round(_tcs3472.rgb()[0]) < (Math.round(_tcs3472.rgb()[1] / 1.5))) && ((Math.round(_tcs3472.rgb()[1])) > 1200) &&
            (Math.round(_tcs3472.rgb()[1] / 1.5) > (Math.round(_tcs3472.rgb()[2])))) { 
            return 1
            //绿
        }
         
        if ((Math.round(_tcs3472.rgb()[0]) < (Math.round(_tcs3472.rgb()[2] / 3))) && (Math.round(_tcs3472.rgb()[1]) < (Math.round(_tcs3472.rgb()[2] / 1.5))) &&
            (Math.round(_tcs3472.rgb()[1]) > 1200)) { 
            return 2
            //蓝
        }

        if ((Math.round(_tcs3472.rgb()[0]) > (Math.round(_tcs3472.rgb()[2] / 1.2))) && (Math.round(_tcs3472.rgb()[1]) > (Math.round(_tcs3472.rgb()[0] / 1.2))) &&
            (Math.round(_tcs3472.rgb()[2]) > Math.round(_tcs3472.rgb()[1] / 1.5) && Math.round(_tcs3472.rgb()[2]) > 1800)) { 
            return 4
            //白
        }

        if ((Math.round(_tcs3472.rgb()[0]) < 800) && ( (Math.round(_tcs3472.rgb()[1]) < 780 ) &&   (Math.round(_tcs3472.rgb()[2]) < 760))){ 
            return 5
            //黑
        }

        if ((Math.round(_tcs3472.rgb()[0]) > (Math.round(_tcs3472.rgb()[1] / 1.3))) && (Math.round(_tcs3472.rgb()[0] / 1.3) < (Math.round(_tcs3472.rgb()[1]))) &&
            (Math.round(_tcs3472.rgb()[0] / 2) > (Math.round(_tcs3472.rgb()[2])) && (Math.round(_tcs3472.rgb()[1]/2) > (Math.round(_tcs3472.rgb()[2]))))) { 
            return 3
            //黄
        }
        return 6
